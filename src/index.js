...
for (let i = 1; i <= cubeCount; i += 1) {
  let c = createCube();
  c.position.x = Math.random() * 400 - 200; //gives random no from -200 to 200
  c.position.y = Math.random() * 400 - 200; //gives random no from -200 to 200
  c.position.z = Math.random() * 400 - 200; //gives random no from -200 to 200
  cubes.push(c);
}
